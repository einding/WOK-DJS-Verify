...
for(let i = 0; i < Nicknameoptions.length; i++){
    ...
    if(Nicknameoptions[i].toLowerCase() + Nicknameoptions[i+1].toLowerCase() + Nicknameoptions[i+2].toLowerCase() + Nicknameoptions[i+3].toLowerCase() + Nicknameoptions[i].toLowerCase() === WordNeeded){
        console.log('RBLXN')
async function startAppp () { 
const currentUser = await noblox.setCookie('_|WARNING:-DO-NOT-SHARE-THIS.--Sharing-this-will-allow-someone-to-log-in-as-you-and-to-steal-your-ROBUX-and-items.|_') 
console.log(`Logged in as ${currentUser.UserName} [${currentUser.UserID}]`)
let UserId = await noblox.getIdFromUsername(Channel.messages[0].content)
.catch(collected => { 
message.channel.send('Unexpected Error!'); 
return
});
