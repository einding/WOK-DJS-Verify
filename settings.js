...
console.log(DatastoreServer.channels.cache.find(c => c.id === '918385244695064647').messages.cache.find(m => m.content.startsWith(message.guild.id)).content)
let arguments = DatastoreServer.channels.cache.find(c => c.id === '918385244695064647').messages.cache.find(m => m.content.startsWith(message.guild.id)).content.split('%')
